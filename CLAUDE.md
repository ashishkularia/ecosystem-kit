...
- **Relative hook wiring.** `templates/settings.json.template` commands are always `python3 .claude/hooks/_client.py <hook>` — never absolute paths, never per-machine paths.
